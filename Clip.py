...
print("Saving model to this location: Data/Output/Models2/CLIP_CROSS2_epoch_")
...
print("Loss: segmentation_criterion = nn.CrossEntropyLoss()")
...
for epoch in tqdm(range(epochsNum), desc="Training Progress"):
    ...
    print(f"Saved here: Data/Output/Models_DICEONLY/CLIP_DiceOnly_epoch_{epoch+1}.pth")
    torch.save(segmentation_model.state_dict(), f'Data/Output/Models_DICEONLY/CLIP_DiceOnly_epoch_{epoch+1}.pth')
